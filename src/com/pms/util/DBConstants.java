...
public interface DBConstants {
	...
	String UPDATE_APP_PROPS_QUERY="UPDATE APPLICATION_PROPS SET KEY_VALUE=? WHERE KEY=?";
	...
	String READ_SELECTED_CHANNEL_DETAILS_OF_USER_QUERY = "SELECT * FROM CHANNEL_DETAILS WHERE CHANNEL_ID IN ( SELECT CHANNELID FROM USER_CHANNEL_DETAILS WHERE USERID=?)"; 
	String READ_UNSELECTED_CHANNEL_DETAILS_OF_USER_QUERY = "SELECT * FROM CHANNEL_DETAILS WHERE CHANNEL_ID NOT IN ( SELECT CHANNELID FROM USER_CHANNEL_DETAILS WHERE USERID=?)"; 
	String DELETE_CHANNEL_DETAILS_QUERY="DELETE FROM CHANNEL_DETAILS WHERE CHANNEL_ID =?";
    String UPDATE_CHANNEL_DETAILS_QUERY="UPDATE CHANNEL_DETAILS SET CHANNEL_NAME=?,CHANNEL_PRICE=?,CHANNEL_TYPE=? WHERE CHANNEL_ID =?";
    ...
    String DELETE_USER_CHANNEL_DETAILS_QUERY="DELETE FROM USER_CHANNEL_DETAILS WHERE USERID =?";
