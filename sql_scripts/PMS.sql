...
--26/01/2019--CREATE MEMORY TABLE PUBLIC.CHANNEL_DETAILS(CHANNEL_ID INTEGER PRIMARY KEY,CHANNEL_NAME VARCHAR(200),CHANNEL_PRICE INTEGER , CHANNEL_TYPE VARCHAR(2));
